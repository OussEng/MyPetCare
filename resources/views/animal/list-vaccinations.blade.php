...
@section('content')
    ...
    <div class="mb-96">
        ...
        <div class="mb-60">
            ...
            @if(in_array($animal->espece->libelle, ['Hamster','Cochon d’Inde','Reptile','Poisson']))

                <div class="flex justify-center">
                    <div
                        class="flex items-start gap-3 p-4 mb-6 text-sm rounded-lg border border-blue-200 bg-blue-50 text-blue-800 w-1/4 mt-32"
                        role="alert">
                        <div class="flex-shrink-0">
                            <svg class="w-5 h-5 mt-0.5" xmlns="http://www.w3.org/2000/svg" fill="none"
                        ...
                        <div>
                            ...
                            <p class="mt-1">
                                Cet animal ne nécessite pas de vaccination.
                            </p>
                        </div>
                    </div>
                </div>
