...
@section('content')
    <div class="flex justify-center mt-14">
        <div class="w-2/3">
                ...
                <h1 class="mb-4 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-white">Nos vétérinaires de confiance</h1>
