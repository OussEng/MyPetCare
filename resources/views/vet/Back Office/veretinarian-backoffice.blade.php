...
@section('content')
    ...
    <div class="flex justify-center mt-20 " >
        <div class="max-w-80 w-full mr-5 transition delay-100 duration-300 ease-in-out hover:-translate-y-1 hover:scale-110">
            ...
            <a class="inline-flex justify-center items-center text-sm text-white bg-indigo-600 hover:bg-indigo-700 active:scale-95 transition-all w-full h-10 mt-5 rounded-md" href="{{ route('vet.rendez-vous.list', ['jour' => "aujourd'hui"])}}">
                Voir
            </a>        </div>
        ...
        <div class="max-w-80 w-full transition delay-100 duration-300 ease-in-out hover:-translate-y-1 hover:scale-110">
            <div class="pt-3 overflow-hidden bg-gray-100 border border-gray-200 rounded-md shadow">
                ...
                <div class="text-gray-900 bg-white pb-3 pt-6 space-y-1 text-sm flex justify-center">
                   <span class="text-5xl text-yellow-500 font-bold">{{count($pending)}}</span>
                </div>
            </div>
            <a class="inline-flex justify-center items-center text-sm text-white bg-indigo-600 hover:bg-indigo-700 active:scale-95 transition-all w-full h-10 mt-5 rounded-md" href="{{ route('vet.rendez-vous.list', ['etat' => 'en attente']) }}">
                Voir
            </a>
