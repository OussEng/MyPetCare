...
@section('content')
    ...
    <div class="relative w-full min-h-screen bg-cover bg-center" style="background-image: url('{{ asset('imgs/cat.jpg') }}');">

        <!-- Dark overlay (optional) -->
        <div class="absolute inset-0 bg-black bg-opacity-40"></div>

        <!-- Profile Content (your original layout) -->
            ...
            <div class="w-full lg:w-2/3">
                ...
                <div class="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto">
                    ...
                    <div class="w-full lg:w-2/5">
                        <img src="{{asset('imgs/pfp.png')}}" class="rounded-none lg:rounded-lg shadow-2xl hidden lg:block h-96" alt="">
                    </div>
                    <!-- Main Col -->
                    <div id="profile"
                        ...
                        <div class="p-4 md:p-12 text-center lg:text-left">
                            ...
                            <img src="{{asset('imgs/pfp.png')}}" class="block lg:hidden rounded-full shadow-xl mx-auto -mt-16 h-48 w-48 bg-cover bg-center" alt="">
