...
<footer class="bg-neutral-primary-soft">
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
            ...
            <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                <div>
                    ...
                    <ul class="text-body font-medium">
                        <li class="mb-4">
                            <a target="_blank" href="https://github.com/OussEng" class="hover:underline ">Github</a>
                        </li>
                    </ul>
                </div>
                <div>
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
          <span class="text-sm text-body sm:text-center">© {{now()->year}} <a target="_blank" href="https://github.com/OussEng" class="hover:underline">OussEng™</a>. All Rights Reserved.
          </span>
            <div class="flex mt-4 sm:justify-center sm:mt-0">
                <a target="_blank" href="https://github.com/OussEng" class="text-body hover:text-heading ms-5">
